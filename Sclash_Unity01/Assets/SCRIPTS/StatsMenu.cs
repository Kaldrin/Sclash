...
public class StatsMenu : MonoBehaviour
{
    ...
    IEnumerator UpdateDisplayedGamesInfos()
    {
        ...
        for (int i = 0; i < stats.globalStats[currentStatMode].gamesList.Count; i++)
        {
            ...
            currentlyInstantiatedGameStat.character2Name.text = characters.charactersList[stats.globalStats[currentStatMode].gamesList[i].character2].name;
            ...
            currentlyInstantiatedGameStat.characterIllustration2.sprite = characters.charactersList[stats.globalStats[currentStatMode].gamesList[i].character2].illustration;
