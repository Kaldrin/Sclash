...
// HEADER
// Reusable script
// Originaly script made by ???

/// <summary>
/// This editor script creates a tool to combine selected meshes in the scene, creating new meshes in the assets
/// </summary>
...
public class MeshCombineWizard : ScriptableWizard {
    ...
    void OnWizardCreate()                                                                                                                                               // ON WIZARD CREATE
    {
        ...
        foreach (var entry in materialToMeshFilterList)
        {
            ...
            AssetDatabase.CreateAsset(combinedMesh, "Assets/CombinedMeshes/CombinedMeshes_" + materialName + ".asset");
        ...
        PrefabUtility.SaveAsPrefabAsset(resultGO, "Assets/CombinedMeshes/" + resultGO.name + ".prefab");
